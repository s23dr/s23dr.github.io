...
DS_BASE = Path("/Users/dmytromishkin/dev/old_hf_s23dr_prev_years/S23DR2025_ds")
TEAMS_FILE = DS_BASE / "teams.json"
SUBMISSION_INFO_DIR = DS_BASE / "submission_info"
OUT_FILE = Path("2025/data/leaderboard.json")
...
def main():
    ...
    # Sort by private hss_mean descending (higher is better, nulls last)
